...
func startTestTarget(t *testing.T, host, name string) func() {
	...
	srv := &http.Server{Addr: host, Handler: http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		fmt.Fprintf(w, "workspace %s hit: %s\n", name, r.URL.String())
	})}
	go srv.Serve(l)
	...
	tests := []struct {
	...
	}{
		{
			...
			Expectation: Expectation{
				...
				Header: http.Header{"Content-Length": {"60"}, "Content-Type": {"text/plain; charset=utf-8"}},
				Body:   "workspace supervisor hit: /_supervisor/frontend/favicon.ico\n",
			},
		},
		{
			...
			Expectation: Expectation{
				Status: http.StatusOK,
				Header: http.Header{"Content-Length": {"39"}, "Content-Type": {"text/plain; charset=utf-8"}},
				Body:   "workspace IDE hit: /test-version.1234/\n",
			},
		},
		{
		...
		},
		{
			...
			Expectation: Expectation{
				...
				Body: "workspace blobserve hit: /gitpod-io/ide:latest/\n",
			},
		},
		{
		...
		},
		{
			...
			Expectation: Expectation{
				...
				Body: "workspace workspace hit: /?foobar\n",
			},
		},
		{
			...
			Expectation: Expectation{
				...
				Body: "workspace workspace hit: /not-from-blobserve\n",
			},
		},
		{
		...
		},
		{
			...
			Expectation: Expectation{
				...
				Body: "workspace supervisor hit: /_supervisor/v1/status/supervisor\n",
			},
		},
		{
			...
			Expectation: Expectation{
				...
				Body: "workspace supervisor hit: /_supervisor/v1/status/ide\n",
			},
		},
		{
		...
		},
		{
			...
			Expectation: Expectation{
				...
				Body: "workspace supervisor hit: /_supervisor/v1/status/content\n",
			},
		},
		{
		...
		},
		{
			...
			Expectation: Expectation{
				...
				Body: "workspace blobserve hit: /worker-proxy.js\n",
			},
		},
	}
